...
import Casey from "../assets/images/Casey1.jpg";
import Resume from "../assets/images/ProResume1.1.pdf";
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-xl-8 col-l-8 col-md-8 col-sm-12" id="about">
                            <h3>About Me</h3>
                            <img src={Casey} alt="" className="mypic"></img>
                            <p>
                        ...
                        <div className="col-xl-4 col-l-4 col-md-4 col-sm-12" id="contact">
                            ...
                            <ul>
                                ...
                                <li>
                                    <b>Resume:</b> <a href= {Resume} target="_blank" rel="noreferrer">Click Here!</a>
                                </li>
                                <li>
                                    <b>LinkedIn:</b> <a
